...
public class ValidFilterJWT extends BasicAuthenticationFilter {
    ...
    public ValidFilterJWT(AuthenticationManager authenticationManager) {
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationToken(String token){
        String user = JWT.require(Algorithm.HMAC512(FilterAuthJWT.TOKEN_SENHA)).build().verify(token).getSubject();
